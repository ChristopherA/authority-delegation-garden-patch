...
- How should Agentic Architecture relate to [[Deep Context Architecture]] as a sub-domain? Many patterns here are instantiations of deeper Deep Context Architecture principles in an agentic context.
...
- Deep Context Garden development (2026-03) — empirical source for the shearing layers and config-state conflation patterns
