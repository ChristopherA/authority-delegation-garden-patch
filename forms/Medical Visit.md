...
- **Body predicates**: `is_a::[[Medical Visit]]`, `relates_to::` for Health Overview and each condition discussed
...
- relates_to::[[Person Note]] — provider person notes created from visit context
