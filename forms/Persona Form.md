...
Naming heuristic: role noun with "Persona" suffix — `[Role] Persona`. "Groundskeeper Persona" not "Garden Orchestration Persona." Name who the agent is, not what the form type is. Use the full name in wikilinks: `[[Garden Groundskeeper Persona]]`.
...
- `in_precinct::[[Garden Precinct]]` or `[[Household Precinct]]`
- `coordinates_with::[[Persona Form]]` — other personas in the same system
- `follows::[[Principle Form]]` — principles that constrain behavior
- `operates_in::[[Domain Form]]` — knowledge domains the persona works within
...
- [[Garden Groundskeeper Persona]] — Garden Precinct orchestrator (first instance; first compound persona)
- [[Estate Chamberlain Persona]] — estate-level operational coordinator (first born-compound persona)
- [[Garden Gardener Persona]] — Garden Precinct worker (first instance; atomic)
