...
- `implements::[[Pattern Form]]` — patterns the skill operationalizes
- `follows::[[Principle Form]]` — principles that constrain execution
- `reads::[[Form Type]]` — form types the skill needs to load during execution
- `follows::[[Protocol Form]]` — protocols the skill adheres to
...
- relates_to::[[Pattern Form]] — skills operationalize patterns into executable procedures
- relates_to::[[Protocol Form]] — skills may implement protocols for single-agent execution
- relates_to::[[Decision Form]] — skill design involves decisions about approach and trade-offs
